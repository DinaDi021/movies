    ...
    <div className={styles.sortDiv}>
      <FormControl
        ...
        sx={{
          "& .MuiInputLabel-root": {
            color: "#005B64",
            "&.Mui-focused": { color: "#164044" },
          },
          "& .MuiOutlinedInput-root": {
            "&.Mui-focused fieldset": { borderColor: "#005B64" },
          },
          "& .MuiSelect-root": {
            color: "#005B64",
            "&:hover": { color: "#164044" },
      ...
      >
        <InputLabel htmlFor="my-select">Sort by</InputLabel>
        <Select
        ...
        >
          ...
          <MenuItem value="popularity.asc">
            Popularity <ArrowUpwardIcon></ArrowUpwardIcon>{" "}
          </MenuItem>
          <MenuItem value="popularity.desc">
            Popularity <ArrowDownwardIcon></ArrowDownwardIcon>
          </MenuItem>
          <MenuItem value="vote_average.asc">
            <span>Vote Average</span> <ArrowUpwardIcon></ArrowUpwardIcon>
          </MenuItem>
          <MenuItem value="vote_average.desc">
            Vote Average <ArrowDownwardIcon></ArrowDownwardIcon>
          </MenuItem>
          <MenuItem value="release_date.asc">
            Release Date <ArrowUpwardIcon></ArrowUpwardIcon>
          </MenuItem>
          <MenuItem value="release_date.desc">
            Release Date <ArrowDownwardIcon></ArrowDownwardIcon>
          </MenuItem>
        </Select>
      </FormControl>
    </div>
